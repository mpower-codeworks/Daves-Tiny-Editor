...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; parse command line for the startup file     ;
; when user drops a file on the app to launch ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
MainEntry proc NEAR
    ...
    ; not using LOCAL HWND any more
    ; no bytes saved, unfortunately
    ; LOCAL   hwnd:      HWND
...
WndProc proc hWnd:HWND, uMsg:UINT, wParam:WPARAM, lParam:LPARAM
    ...
    NotWMSysCommand:
        ...
        ; only handle EDIT control messages
        ;mov     eax, lParam
        ;cmp     eax, hEdit
        ;jne     CommandDone
    ...
    NotWMCommand:
        ...
        ; check if EDIT exists and resize it
	...
	; this could error but saves 3 bytes
	; it should be: push hEdit
        push    eax
