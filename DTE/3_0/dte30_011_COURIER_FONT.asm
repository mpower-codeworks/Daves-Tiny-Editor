...
;;;;;;;;;;;;;;
    ...
    push    0Dh                 ; thirteen remaining font arguments
    pop     ecx                 ; ECX = compact zero-push counter

CourierZeros:
    push    edi                 ; push one zero CreateFont argument
    loop    CourierZeros        ; repeat for all thirteen arguments

    call    [__imp__CreateFontA@56] ; create default-size Courier HFONT
