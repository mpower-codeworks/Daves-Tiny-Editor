...
FONT_HEIGHT_ADDR EQU 4003FCh             ; file offset 1020 signed height
                                         ; configurator owns bytes 1000-1023
...
PrintKey:
    ...
    pop     ecx
    rep     movsd                       ; copy "notepad /p \"" before pathname

    mov     word ptr [eax], 22h         ; temporary quote plus trailing NUL
    push    eax                         ; retain clean title terminator
    ...
    pop     eax                         ; restore clean title terminator pointer
    mov     byte ptr [eax], 0           ; remove temporary closing quote
