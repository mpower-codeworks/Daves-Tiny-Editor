...
;; 047 window state tail         - build to measure
...
;;;;;;;;;;;;;;;;;;;;;;;
WINDOW_MODE_ADDR EQU 4003E4h             ; file offset 996 in mapped image
                                         ; 00000000h = normal/windowed
                                         ; 01000000h = add WS_MAXIMIZE
FONT_FACE_ADDR   EQU 4003E8h             ; file offset 1000 in mapped image
FONT_HEIGHT_ADDR EQU 4003FCh             ; file offset 1020 signed height
                                         ; font face occupies bytes 1000-1019
                                         ; bytes below 996 remain open
...
DropReady:
    ...
    push    edi                         ; Y            = zero
    push    edi                         ; X            = zero
    mov     eax, dword ptr [WINDOW_MODE_ADDR]
                                         ; zero = windowed, bit 24 = maximized
