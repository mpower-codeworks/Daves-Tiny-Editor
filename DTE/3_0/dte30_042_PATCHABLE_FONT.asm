...
;; 043 external font patch tail  - 988 bytes
...
;; PatchableFont ;;
;;;;;;;;;;;;;;;;;;
    push    FONT_FACE_ADDR               ; lpszFace = external patch tail
...
FontZeros:
    ...
    push    dword ptr [FONT_HEIGHT_ADDR] ; nHeight = configurator-selected size
