...
DropReady:
    mov     eax, OFFSET TitleStart      ; EAX = title-state pair
    mov     dword ptr [eax], edx        ; retain filename title pointer
    mov     dword ptr [eax+4], edi      ; retain clean title terminator
...
SaveFile:
    ...
    xor     eax, eax                    ; EAX = compact Save zero
