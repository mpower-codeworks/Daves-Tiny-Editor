...
DTE is basically a wrapper around the EDIT control from the WinAPI. It does not set a custom font. It uses the native default font supplied by the Windows EDIT control - probably MS Sans Serif on most systems. It's a proportional font, so good for writing letters, but not so much for coding.
...
[BACKUPS]   -- the history of building up DTE. <br>
