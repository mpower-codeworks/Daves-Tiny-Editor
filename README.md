...
This is an extension of tiny.asm Hello Windows by Dave Plummer. The idea is to make a working windowed text editor in the sub 1kb category. It uses Crinkler compression at build time.
