...
You need to have Crinkler installed in a directory that has been added to PATH.<br>Example: C:\utils\Crinkler.exe
Build the exe in a folder that has been excluded from antivirus check.<br>Example: C:\assem_test\
